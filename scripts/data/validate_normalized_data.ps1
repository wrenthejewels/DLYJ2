...
$headerMap = @{
    ...
    'occupation_selector_index.csv' = @('occupation_id','title','role_family','search_blob','employment_us','median_wage_usd','projection_growth_pct','manning_exposure_score','manning_adaptive_capacity_score','selector_weight','coverage_tier')
    ...
    'occupation_labor_market_context.csv' = @('occupation_id','employment_us','annual_openings','median_wage_usd','wage_p25_usd','wage_p75_usd','projection_growth_pct','labor_market_confidence','release_year')
